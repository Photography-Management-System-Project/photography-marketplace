...
export const AdminCoupons = () => {
  ...
  useEffect(() => {
    javaApi.get('/admin/coupons').then(res => setCouponsList(res.data)).catch(console.error);
  }, []);
  ...
  const handleAddCoupon = async () => {
    ...
    try {
      const res = await javaApi.post('/admin/coupons', newCoupon);
  ...
  const handleRemoveCoupon = async (id) => {
    try {
      await javaApi.delete(`/admin/coupons/${id}`);
